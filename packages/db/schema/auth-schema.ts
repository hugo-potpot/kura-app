...
// ── BetterAuth tables (PostgreSQL only) ────────────────────────────────────
// Ces tables sont gérées exclusivement par BetterAuth côté serveur (Next.js).
// Ne pas les importer dans les schémas SQLite (mobile).
